      ...
      .then(token => {
        if (token !== null) {
          ...
          axios({
            method: 'GET',
            url:
              'https://datafit-api.herokuapp.com/api/mobile/exercises/' +
              id +
              '/uploads',
            headers: headers,
          })
    ...
    return (
      <View style={styles.container}>
        <SafeAreaView style={styles.safeAreaView}>
          <ScrollView>
            <ImageBackground
              source={require('../../assets/images/air-squat.png')}
            ...
            {this.state.uploads.map((upload, index) => (
              <View style={styles.row}>
                <View style={styles.measurementsColIcon}>
                  {Object.keys(upload.uploads.number_of_problems).length ==
                  0 ? (
                    <Image
                      source={require('../../assets/images/oval-green-icon.png')}
                      style={styles.ovalIcon}
                    />
                  ) : (
                    <Image
                      source={require('../../assets/images/oval-red-icon.png')}
                      style={styles.ovalIcon}
                    />
                  )}
                </View>
                <TouchableHighlight
                  ...
                  <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{alignItems: 'flex-end', width: '40%'}}>
                      <Text style={styles.exerciseResultDate}>
                        {upload.uploads.created_at}
                      </Text>
                    </View>
                  </View>
                </TouchableHighlight>
        ...
        <View style={styles.footer}>
          ...
          <View style={styles.footerCol}>
            <TouchableHighlight
              ...
              <View style={{width: 50, height: 20}}>
                <Image
                  source={require('../../assets/images/home/profile-icon.png')}
                />
              </View>
            </TouchableHighlight>
          </View>
